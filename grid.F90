...
logical notopened3D_homo  ! flag to see if the 3D output datafile is opened	
...
#ifdef UWM_MISC
logical:: scamiop_from_global_cam = .false. ! iop file is from a global cam
                                            ! simulation. sam_clubb:ticket:87
#endif
...
integer :: nstep_homo1 = 99999999 ! for environment homogenization experiments
integer :: nstep_homo2 = 99999999 ! for environment homogenization experiments
!-----------------------------------------
end module grid
