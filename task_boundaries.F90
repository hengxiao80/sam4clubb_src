...
#ifdef CLUBB
 ! Vince Larson (UWM) changed so that task_exchange is called even when 
 !    docloud = .false. and doclubb = .true.  2007
#endif
...
#ifdef PNNL_STATS
 !MWSWong:added for thel and qtog budget
 call task_exchange(thel,dimx1_s,dimx2_s,dimy1_s,dimy2_s,nzm,3+NADVS,3+NADVS,3+NADVS,3+NADVS,&
                             4+nsgs_fields+nsgs_fields_diag+nmicro_fields+ntracers+1)
 call task_exchange(qtog,dimx1_s,dimx2_s,dimy1_s,dimy2_s,nzm,3+NADVS,3+NADVS,3+NADVS,3+NADVS,&
...
#ifdef PNNL_STATS
 !MWSWong:added for thel budget
 call task_exchange(thel,dimx1_s,dimx2_s,dimy1_s,dimy2_s,nzm,1,1,1,1,&
                       4+nsgs_fields+nsgs_fields_diag+nmicro_fields+ntracers+1)
 call task_exchange(qtog,dimx1_s,dimx2_s,dimy1_s,dimy2_s,nzm,1,1,1,1,&
                       4+nsgs_fields+nsgs_fields_diag+nmicro_fields+ntracers+2)
#endif /*PNNL_STATS*/
